                            ...
                            <p>
                                ...
                                @if($footers) 
                                    <a href="{{ route('welcome') }}">
                                        {{ $footers->app_name }}.</a> Developed by <a href="{{ $footers->developer_link }}" target="_blank">{{ $footers->developer_name }}.</a> Theme by <a href="{{ $footers->theme_by }}"  target="_blank">{{ $footers->theme_by_name }}</a>
                                @endif
                            </p>
                        </div>
                    </div>
